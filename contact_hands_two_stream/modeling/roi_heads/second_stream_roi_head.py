...
class SecondStreamROIHeads(StandardROIHeads):
    """
    ...
    def __init__(self, cfg, input_shape):
        super(SecondStreamROIHeads, self).__init__(cfg, input_shape)
    ...
    def forward(
        ...
        if self.training:
            ...
            second_stream_outputs = self.forward_with_given_boxes(features, pred_instances)
    ...
    def forward_with_given_boxes(
        ...
        second_stream_outputs = self._forward_mask(features, instances)
        return second_stream_outputs
